...
{ 
    public string TestGameManager()
    {
        ...
        playerList.Add(new HumanPlayer(new ResourceGroup(10, 10, 10), "dave", 100));
        playerList.Add(new AIPlayer(new ResourceGroup(10, 10, 10), "tim", 100));
        ...
        AbstractPlayer winner = gameManager.GetWinnerIfGameHasEnded();
        ...
        List<AbstractPlayer> playerList2 = new List<AbstractPlayer>();
        playerList2.Add(new AIPlayer(new ResourceGroup(10, 10, 10), "leo", 100));
        playerList2.Add(new AIPlayer(new ResourceGroup(10, 10, 10), "leo2", 100));
        playerList2.Add(new AIPlayer(new ResourceGroup(10, 10, 10), "leo3", 100));
        playerList2.Add(new AIPlayer(new ResourceGroup(10, 10, 10), "leo4", 100));
        playerList2.Add(new HumanPlayer(new ResourceGroup(10, 10, 10), "dave", 100));
        playerList2.Add(new HumanPlayer(new ResourceGroup(10, 10, 10), "dave2", 100));
        playerList2.Add(new HumanPlayer(new ResourceGroup(10, 10, 10), "dave3", 100));
        playerList2.Add(new HumanPlayer(new ResourceGroup(10, 10, 10), "dave4", 100));
